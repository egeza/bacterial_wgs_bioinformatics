...
## Running the *de novo* assembly pipeline
 - Git clone <https://github.com/egeza/Tychus.git> into /users/username/bacterial_wgs_training directory.
 - The pipeline involves two modules: assembly and alignment.
 - This section will focus on the assembly <https://github.com/egeza/Tychus/blob/master/assembly.nf> module.
